...
> **Note:** in order to avoid large names, the URL of the project is an abbreviation of the name of this repository (profile-card-component -> pcc) with its unique ID (for less problems with names already taken).
